  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      toast({
        ...
        description: "Welcome to HouseHunt. Please check your email to verify your account.",
      });
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50 flex items-center justify-center px-4 py-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">Join HouseHunt to find your perfect home</p>
        </div>
